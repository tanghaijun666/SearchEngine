...
CREATE TABLE `comments`  (
  ...
  `to_user_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '被评论的用户id',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户粉丝关联关系表' ROW_FORMAT = DYNAMIC;
